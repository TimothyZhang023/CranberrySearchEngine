...
public class RedisClientTest {
    ...
    public static void main(String[] args) {
        ...
        redisClientTest.KeyOperate();
        redisClientTest.StringOperate();
        redisClientTest.ListOperate();
        redisClientTest.SetOperate();
        redisClientTest.SortedSetOperate();
        redisClientTest.HashOperate();
        redisClientTest.getJedisPool().returnResource(redisClientTest.getJedis());
        redisClientTest.getShardedJedisPool().returnResource(redisClientTest.getShardedJedis());
